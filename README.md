...
[![Documentation
Status](https://readthedocs.org/projects/dgenerate/badge/?version=v3.2.1)](http://dgenerate.readthedocs.io/en/v3.2.1/)
...
[readthedocs](http://dgenerate.readthedocs.io/en/v3.2.1/).
...
options:
  ...
  -mc EXPR [EXPR ...], --cache-memory-constraints EXPR [EXPR ...]
                        ...
                        Syntax See: [https://dgenerate.readthedocs.io/en/v3.2.1/dgenerate_submodules.ht
  ...
  -pmc EXPR [EXPR ...], --pipeline-cache-memory-constraints EXPR [EXPR ...]
                        ...
                        0.75)" For Syntax See: [https://dgenerate.readthedocs.io/en/v3.2.1/dgenerate_su
  ...
  -umc EXPR [EXPR ...], --unet-cache-memory-constraints EXPR [EXPR ...]
                        ...
                        enerate.readthedocs.io/en/v3.2.1/dgenerate_submodules.html#dgenerate.pipelinewr
  ...
  -vmc EXPR [EXPR ...], --vae-cache-memory-constraints EXPR [EXPR ...]
                        ...
                        nerate.readthedocs.io/en/v3.2.1/dgenerate_submodules.html#dgenerate.pipelinewra
  ...
  -cmc EXPR [EXPR ...], --control-net-cache-memory-constraints EXPR [EXPR ...]
                        ...
                        For Syntax See: [https://dgenerate.readthedocs.io/en/v3.2.1/dgenerate_submodule
...
pipx install dgenerate==3.2.1 ^
--pip-args "--extra-index-url https://download.pytorch.org/whl/cu118/"

# You can install without pipx into your own environment like so

pip install dgenerate==3.2.1 --extra-index-url https://download.pytorch.org/whl/cu118/
```
...
pipx install dgenerate[flax]==3.2.1 \
--pip-args "--extra-index-url https://download.pytorch.org/whl/cu118/ \
-f https://storage.googleapis.com/jax-releases/jax_cuda_releases.html"

# You can install without pipx into your own environment like so

pip3 install dgenerate==3.2.1 --extra-index-url https://download.pytorch.org/whl/cu118/

# Or with flax

pip3 install dgenerate[flax]==3.2.1 --extra-index-url https://download.pytorch.org/whl/cu118/ \
-f https://storage.googleapis.com/jax-releases/jax_cuda_releases.html
```
...
> -   [my-image-seed.png](https://raw.githubusercontent.com/Teriks/dgenerate/v3.2.1/examples/media/dog-on-bench.png)
> -   [my-mask-image.png](https://raw.githubusercontent.com/Teriks/dgenerate/v3.2.1/examples/media/dog-on-bench-mask.png)
...
These examples use:
[vermeer_canny_edged.png](https://raw.githubusercontent.com/Teriks/dgenerate/v3.2.1/examples/media/vermeer_canny_edged.png)
...
This image of a
[horse](https://raw.githubusercontent.com/Teriks/dgenerate/v3.2.1/examples/media/horse2.jpeg)
...
cat](https://raw.githubusercontent.com/Teriks/dgenerate/v3.2.1/examples/media/low_res_cat.png)
...
can be found in the
[\"writing_plugins/image_processor\"](https://github.com/Teriks/dgenerate/tree/v3.2.1/examples/writing_plugins/image_processor)
folder of the examples folder.

The source code for the built in
[canny](https://github.com/Teriks/dgenerate/blob/v3.2.1/dgenerate/imageprocessors/canny.py)
processor, the
[openpose](https://github.com/Teriks/dgenerate/blob/v3.2.1/dgenerate/imageprocessors/openpose.py)
processor, and the simple [pillow image
operations](https://github.com/Teriks/dgenerate/blob/v3.2.1/dgenerate/imageprocessors/imageops.py)
...
[\"writing_plugins/config_directive\"](https://github.com/Teriks/dgenerate/tree/v3.2.1/examples/writing_plugins/config_directive)
folder of the examples folder.
...
here](https://github.com/Teriks/dgenerate/blob/v3.2.1/dgenerate/batchprocess/image_process_directive.py),
...
here](https://github.com/Teriks/dgenerate/blob/v3.2.1/dgenerate/image_process).
