...
.. code-block::
    ...
    options:
      ...
      -ci CONTROL_IMAGES [CONTROL_IMAGES ...], --control-images CONTROL_IMAGES [CONTROL_IMAGES ...]
                            ...
                            --image-seed. This argument is mutually exclusive with --image-seed.
      --seed-image-preprocessors PREPROCESSOR [PREPROCESSOR ...]
...
A code example as well as a command line usage example for image
preprocessor plugins can be found `here <https://github.com/Teriks/dgenerate/tree/control_nets/examples/plugins/image_preprocessor>`_
