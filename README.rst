...
.. code-block:: text
    ...
    options:
      ...
      -scm SUB_COMMAND, --sub-command SUB_COMMAND
                            ...
                            essentially replace the entire set of accepted arguments with those of a
                            sub-command which implements additional functionality. See --sub-command-
                            help for a list of sub-commands and help.
      -scmh [SUB_COMMAND ...], --sub-command-help [SUB_COMMAND ...]
      ...
      -un UNET_URI, --unet UNET_URI
                            ...
                            All loading arguments except "dtype" and "revision" are unused in this case
                            and may produce an error message if used. If you wish to load a specific
                            weight file from a huggingface repository, use the blob link loading syntax:
                            --unet "https://huggingface.co/UserName/repository-
                            name/blob/main/unet_model.safetensors", the revision argument may be used
                            with this syntax.
      -vae VAE_URI, --vae VAE_URI
                            ...
                            a dtype "AutoencoderKL;my_vae.safetensors;dtype=float16". All loading
                            arguments except "dtype" and "revision" are unused in this case and may
                            produce an error message if used. If you wish to load a specific weight file
                            from a huggingface repository, use the blob link loading syntax: --vae
      ...
      -lra LORA_URI [LORA_URI ...], --loras LORA_URI [LORA_URI ...]
                            ...
                            directly from disk, the simplest way is: --loras "my_lora.safetensors", or
      ...
      -hnf FLOAT [FLOAT ...], --sdxl-high-noise-fractions FLOAT [FLOAT ...]
                            ...
                            --image-seed-strengths input to the SDXL refiner. (default: [0.8])
      ...
      -if FORMAT, --image-format FORMAT
                            ...
                            pdf, pbm, pgm, ppm, pnm, bw, rgb, rgba, sgi, tga, icb, vda, vst, webp, wmf,
      ...
      -mc EXPR [EXPR ...], --cache-memory-constraints EXPR [EXPR ...]
                            ...
                            > 70" For Syntax See: [https://dgenerate.readthedocs.io/en/v3.0.0/dgenerate_
      ...
      -umc EXPR [EXPR ...], --unet-cache-memory-constraints EXPR [EXPR ...]
                            ...
                            Syntax See: [https://dgenerate.readthedocs.io/en/v3.0.0/dgenerate_submodules
