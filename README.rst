...
.. code-block:: text
    ...
    usage: dgenerate [-h] [-v] [--version] [-pm PATH [PATH ...]] [-scm SUB_COMMAND] [-scmh [SUB_COMMAND ...]]
                     [-ofm] [-th] [-mt MODEL_TYPE] [-rev BRANCH] [-var VARIANT] [-sbf SUBFOLDER] [-atk TOKEN]
                     [-bs INTEGER] [-bgs SIZE] [-vae VAE_URI] [-vt] [-vs] [-lra LORA_URI [LORA_URI ...]]
                     ...
                     [-p PROMPT [PROMPT ...]] [-cs INTEGER [INTEGER ...]] [-se SEED [SEED ...]] [-sei]
                     [-gse COUNT] [-af FORMAT] [-nf] [-fs FRAME_NUMBER] [-fe FRAME_NUMBER] [-is SEED [SEED ...]]
    ...
    options:
      ...
      -cn CONTROL_NET_URI [CONTROL_NET_URI ...], --control-nets CONTROL_NET_URI [CONTROL_NET_URI ...]
                            ...
                            .bin, .ckpt, or .safetensors file), or model folder containing model files.
                            Currently all ControlNet models will receive the same guidance image, in the future
      ...
      -s SIZE, --output-size SIZE
                            ...
                            and 64x64 for --model-type torch-if (Deep Floyd stage 1). Deep Floyd stage 1 images
                            passed to superscaler models (--model-type torch-ifs*) that are specified with the
      ...
      -af FORMAT, --animation-format FORMAT
                            ...
                            Value must be one of: mp4, gif, or webp. You may also specify "frames" to indicate
                            that only frames should be output and no coalesced animation file should be
      ...
      -mc EXPR [EXPR ...], --cache-memory-constraints EXPR [EXPR ...]
                            ...
                            eadthedocs.io/en/v3.0.0/dgenerate_submodules.html#dgenerate.pipelinewrapper.CACHE_ME
                            MORY_CONSTRAINTS]
      -pmc EXPR [EXPR ...], --pipeline-cache-memory-constraints EXPR [EXPR ...]
                            ...
                            te.readthedocs.io/en/v3.0.0/dgenerate_submodules.html#dgenerate.pipelinewrapper.PIPE
      ...
      -vmc EXPR [EXPR ...], --vae-cache-memory-constraints EXPR [EXPR ...]
                            ...
                            /v3.0.0/dgenerate_submodules.html#dgenerate.pipelinewrapper.VAE_CACHE_MEMORY_CONSTRA
                            INTS]
      -cmc EXPR [EXPR ...], --control-net-cache-memory-constraints EXPR [EXPR ...]
                            ...
                            dgenerate.readthedocs.io/en/v3.0.0/dgenerate_submodules.html#dgenerate.pipelinewrapp
