...
.. code-block::
    ...
    options:
      ...
      --batch-grid-size SIZE
                            ...
                            ROWSxCOLUMNS given to this argument when --batch-size is greater than 1, or
      ...
      --sdxl-refiner MODEL_URI
                            ...
                            float32. If you wish to load a weights file directly from disk, the
      ...
      -is SEED [SEED ...], --image-seeds SEED [SEED ...]
                            ...
                            file on disk. When using --control-nets, a singular image specification is
                            interpreted as the control guidance image. Using --control-nets with
                            img2img or inpainting can be accomplished with the syntax: "my-seed-
                            image.png;mask=my-image-mask.png;control=my-control-
                            ...
                            seeds is capable of reading from 3 animated files at once or any
      ...
      --control-image-preprocessors PREPROCESSOR [PREPROCESSOR ...]
                            ...
                            image specified by --image-seeds. For example: --control-image-
                            preprocessors "canny;lower=50;upper=100". This option is ment to be used in
                            combination with --control-nets. To obtain more information about what
                            image preprocessors are available and how to use them, see: --image-
                            preprocessor-help.
