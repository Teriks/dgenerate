.. |Documentation| image:: https://readthedocs.org/projects/dgenerate/badge/?version=v6.0.0
   :target: http://dgenerate.readthedocs.io/en/v6.0.0/
...
For the extensive usage manual, manual installation guide, and API documentation, visit `readthedocs <http://dgenerate.readthedocs.io/en/v6.0.0/>`_.
...
* `Windows <https://dgenerate.readthedocs.io/en/v6.0.0/manual.html#windows-install>`_
* `Linux / WSL <https://dgenerate.readthedocs.io/en/v6.0.0/manual.html#linux-or-wsl-install>`_
* `Linux ROCm <https://dgenerate.readthedocs.io/en/v6.0.0/manual.html#linux-with-rocm-amd-cards>`_
* `MacOS <https://dgenerate.readthedocs.io/en/v6.0.0/manual.html#macos-install-apple-silicon-only>`_
* `Google Colab <https://dgenerate.readthedocs.io/en/v6.0.0/manual.html#google-colab-install>`_
* `XPU (Intel) <https://dgenerate.readthedocs.io/en/v6.0.0/manual.html#install-with-xpu-support>`_
* `Installing From Development Branches <https://dgenerate.readthedocs.io/en/v6.0.0/manual.html#installing-from-development-branches>`_
