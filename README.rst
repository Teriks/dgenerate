...
.. code-block::
    ...
    options:
      ...
      --sdxl-refiner MODEL_URI
                            ...
                            -t/--dtype and should be one of: auto, float16, or float32. If you wish to
                            load a weights file directly from disk, the simplest way is: --sdxl-
      ...
      -hnf FLOAT [FLOAT ...], --sdxl-high-noise-fractions FLOAT [FLOAT ...]
                            ...
                            result in additional generation steps for each value. In certain
      ...
      -is SEED [SEED ...], --image-seeds SEED [SEED ...]
                            ...
                            --image-seeds is capable of reading from 3 animated files at once or any
      ...
      --control-image-preprocessors PREPROCESSOR [PREPROCESSOR ...]
                            ...
                            preprocessors "canny;lower=50;upper=100". This option is ment to be used
                            in combination with --control-nets. To obtain more information about what
      ...
      -igs FLOAT [FLOAT ...], --image-guidance-scales FLOAT [FLOAT ...]
                            ...
                            *-pix2pix models. Use in conjunction with --image-seeds, inpainting
