...
.. code-block:: text
    ...
    usage: dgenerate [-h] [-v] [--version] [-pm PATH [PATH ...]] [-scm SUB_COMMAND]
                     [-scmh [SUB_COMMAND ...]] [-ofm] [-th] [-mt MODEL_TYPE] [-rev BRANCH] [-var VARIANT]
                     [-sbf SUBFOLDER] [-atk TOKEN] [-bs INTEGER] [-bgs SIZE] [-vae VAE_URI] [-vt] [-vs]
    ...
    options:
      ...
      -vae VAE_URI, --vae VAE_URI
                            ...
                            "variant" argument specifies the VAE model variant, if "variant" is specified
                            ...
                            defaults to automatic selection and is ignored if using flax. "variant" in
                            the case of --vae does not default to the value of --variant to prevent
                            ...
                            one of: auto, float16, or float32. If you wish to load a weights file
                            ...
                            to load a specific weight file from a huggingface repository, use the blob
      ...
      -cn CONTROL_NET_URI [CONTROL_NET_URI ...], --control-nets CONTROL_NET_URI [CONTROL_NET_URI ...]
                            ...
                            containing model files. Currently all ControlNet models will receive the same
                            guidance image, in the future this will probably change. Optional arguments
                            ...
                            (bool) They can be specified as so in any order, they are not positional: "hu
                            ggingface/controlnet;scale=1.0;start=0.0;end=1.0;revision=main;variant=fp16;s
                            ...
                            "main"). The "variant" (only for --model-type "torch*") argument specifies
                            the ControlNet model variant, if "variant" is specified when loading from a
      ...
      --sdxl-refiner MODEL_URI
                            ...
                            be a huggingface repository slug / blob link, path to model file on disk (for
                            example, a .pt, .pth, .bin, .ckpt, or .safetensors file), or model folder
                            ...
                            the value of -t/--dtype and should be one of: auto, float16, or float32. If
                            you wish to load a weights file directly from disk, the simplest way is:
      ...
      -mc EXPR [EXPR ...], --cache-memory-constraints EXPR [EXPR ...]
                            ...
                            70" For Syntax See: [https://dgenerate.readthedocs.io/en/v3.0.0/dgenerate_sub
      ...
      -pmc EXPR [EXPR ...], --pipeline-cache-memory-constraints EXPR [EXPR ...]
                            ...
                            (available * 0.75)" For Syntax See: [https://dgenerate.readthedocs.io/en/v3.0
      ...
      -vmc EXPR [EXPR ...], --vae-cache-memory-constraints EXPR [EXPR ...]
                            ...
                            generate.readthedocs.io/en/v3.0.0/dgenerate_submodules.html#dgenerate.pipelin
