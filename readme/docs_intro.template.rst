...
For library usage examples see the `Library Usage Examples <https://github.com/Teriks/dgenerate/tree/@REVISION/examples/library_usage>`_
folder under the examples folder in the github repository.

For command line usage documentation see the `Usage Manual`_
or the `Examples Folder <https://github.com/Teriks/dgenerate/tree/@REVISION/examples>`_ in
