...
For library usage examples see the `Library Usage Examples <https://github.com/Teriks/dgenerate/tree/v3.6.0/examples/library_usage>`_
...
or the `Examples Folder <https://github.com/Teriks/dgenerate/tree/v3.6.0/examples>`_ in
